...
namespace Event_Management_system.Migrations
{
    ...
    [Migration("20231013014304_Init1")]
    partial class Init1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Event_Management_system.Models.Booking", b =>
                {
                    ...
                    b.HasIndex("Sector_Investor_Id");

                    b.HasIndex("Sector_Presenter_Id");
            ...
            modelBuilder.Entity("Event_Management_system.Models.Booking", b =>
                {
                    ...
                    b.HasOne("Event_Management_system.Models.Sector_Investor", "Sector_Investor")
                        .WithMany("Bookings")
                        .HasForeignKey("Sector_Investor_Id")
                        .IsRequired();

                    b.HasOne("Event_Management_system.Models.Sector_Presenter", "Sector_Presenter")
                        .WithMany("Bookings")
                        .HasForeignKey("Sector_Presenter_Id")
                        .IsRequired();

                    b.Navigation("Room");

                    b.Navigation("Sector_Investor");

                    b.Navigation("Sector_Presenter");
                });
