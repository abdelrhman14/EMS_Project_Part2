...
{
    public class RoomsController110 : Controller
    {
        private readonly AppDbContext _context;

        public RoomsController110(AppDbContext context)
        {
            _context = context;
        }
        ...
        {
            ViewData["Hotel_Id"] = new SelectList(_context.Hotels, "Hotel_Id", "City");
            ViewData[""] = new SelectList(_context.Hotels, "Hotel_Id", "City");
        ...
        public async Task<IActionResult> Create([Bind("Room_Id,Name,FromDate,ToDate,Status,Hotel_Id")] Room room)
        {
            ...
            ViewData["Hotel_Id"] = new SelectList(_context.Hotels, "Hotel_Id", "City", room.Hotel_Id);
            return View(room);
        }
