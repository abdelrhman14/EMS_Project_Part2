...
namespace Event_Management_system.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public IActionResult Information(int? searchname, int? Presenter_Id, int? searchsector, DateTime? start, DateTime? end)
        {
            ...
            ViewData["Hotel_Id"] = new SelectList(_context.Sectors, "Hotel_Id", "Name");

            ViewData["Sector_Presenter"] = _context.Sector_Presenters;
            ViewData["Room"] = _context.Rooms;
            ...
            var ee = (from fac in _context.Sector_Presenters
                      select new Sector_Presenter()
                      {
                          ...
                          Sector = fac.Sector,
                          Presenter_Id = fac.Presenter.Presenter_Id,
            ...
            else if (searchname != null && searchsector == null && start == null && end == null)
            {
                ...
                ViewData["Sector_Presenter"] = kk;

                return View(ViewData["Sector_Presenter"]);
            ...
            else if (searchname != null && searchsector != null && start == null && end == null)
            {
                ...
                var rr = (from fac in _context.Sector_Investors
                          ...
                          select new Sector_Presenter()
                          {
                              ...
                              Presenter_Id = sem.Presenter.Presenter_Id,
            ...
            else if (searchname != null && searchsector != null && start != null && end != null)
            {
                ...
                var oo = (from fac in _context.Sector_Investors
                          join sem in _context.Sector_Presenters on fac.Sector_Id equals sem.Sector_Id
            ...
            else if (searchname != null && searchsector == null && start != null && end != null)
            {
                ...
                var zz = (from fac in _context.Sector_Investors
                          join sem in _context.Sector_Presenters on fac.Sector_Id equals sem.Sector_Id
            ...
            else if (searchname == null && searchsector != null && start != null && end != null)
            {
                ...
                var dd = (from fac in _context.Sector_Presenters
                          join sem in _context.Sector_Presenters on fac.Sector_Id equals sem.Sector_Id
                ...
                ViewData["Sector_Presenter"] = dd;

                return View(ViewData["Sector_Presenter"]);

            }
            else if(Presenter_Id != null)
            {
                var presenter = _context.Sector_Presenters.Where(s => s.Sector_Presenter_Id == Presenter_Id);
                ...
                ViewData["Room"] = roomsbooking;

                return View(ViewData["Room"]);
            }


            ViewData["Sector_Presenter"] = ee;
        ...
        [HttpPost]
        public async Task<IActionResult> Create([Bind("Booking_Id,Investor_Id,Presenter_Id,Room_Id")] Booking booking)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["Investor_Id"] = new SelectList(_context.Investors, "Investor_Id", "Name", booking.Investor_Id);
            ViewData["Presenter_Id"] = new SelectList(_context.Presenters, "Presenter_Id", "Name", booking.Presenter_Id);
            ViewData["Room_Id"] = new SelectList(_context.Rooms, "Room_Id", "Room_Id", booking.Room_Id);
            return View(booking);
        }
        public IActionResult GetMatch(int Presenter_Id)
        {
            ViewData["Investor_Id"] = new SelectList(_context.Investors, "Investor_Id", "Name");
            ViewData["Presenter_Id"] = new SelectList(_context.Presenters, "Presenter_Id", "Name");
            var presenter = _context.Sector_Presenters.Where(s => s.Sector_Presenter_Id == Presenter_Id);
